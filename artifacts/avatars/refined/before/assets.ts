...
export default defineAssets({
  ...
  courtMale: { url: `${import.meta.env.BASE_URL}gltf/avatars/courtMale.glb?v=organic-20260912-r2`, type: AssetType.GLTF, name: 'Courtisan Renaissance — avatar anime', priority: 'lazy' },
  courtFemale: { url: `${import.meta.env.BASE_URL}gltf/avatars/courtFemale.glb?v=organic-20260912-r2`, type: AssetType.GLTF, name: 'Dame de cour Renaissance — avatar anime', priority: 'lazy' },
