...
export default defineAssets({
  ...
  palaceInterior: { url: `${import.meta.env.BASE_URL}gltf/castle/palaceInterior.glb?v=chimney-walls-20260910`, type: AssetType.GLTF, name: 'Salons et grand escalier — Blender', priority: 'lazy' },
  ...
  bustFrancoisI: { url: `${import.meta.env.BASE_URL}gltf/castle/bustFrancoisI.glb`, type: AssetType.GLTF, name: 'Francois Ier — portrait sculpte', priority: 'lazy' },
  bustLouisXIV: { url: `${import.meta.env.BASE_URL}gltf/castle/bustLouisXIV.glb`, type: AssetType.GLTF, name: 'Louis XIV — portrait sculpte', priority: 'lazy' },
  courtMale: { url: `${import.meta.env.BASE_URL}gltf/avatars/courtMale.glb?v=natural-20260912-r2`, type: AssetType.GLTF, name: 'Courtisan Renaissance — avatar anime', priority: 'lazy' },
  courtFemale: { url: `${import.meta.env.BASE_URL}gltf/avatars/courtFemale.glb?v=natural-20260912-r2`, type: AssetType.GLTF, name: 'Dame de cour Renaissance — avatar anime', priority: 'lazy' },
